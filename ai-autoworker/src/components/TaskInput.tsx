  ...
  return (
    <section className="rounded-lg border border-zinc-800 bg-zinc-900/70 p-4 shadow-lg sm:p-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        />
        <button className="h-11 rounded-lg border border-zinc-600 bg-zinc-100 px-5 text-sm font-semibold text-zinc-950 transition-all duration-200 hover:-translate-y-0.5 hover:bg-white">
          Run Task 🚀
        </button>
      </div>
    </section>
